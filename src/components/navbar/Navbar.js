  ...
  return (
    <nav className="navbar navbar-dark">
      <div className="navbar-brand" >
        <svg className="bi bi-people" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="title">Expendable Humanoid Tracker</span>
      </div>
    </nav>
  )
}
